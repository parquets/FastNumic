...
void add(int M, int N, const double *A, int lda, const double* B, int ldb, double* C, int ldc) {
    int m = 0;
...
void sub(int M, int N, const double *A, int lda, const double* B, int ldb, double* C, int ldc) {
    int m = 0;
...
void mul(int M, int N, const double *A, int lda, const double* B, int ldb, double* C, int ldc) {
    int m = 0;
...
void div(int M, int N, const double *A, int lda, const double* B, int ldb, double* C, int ldc) {
    int m = 0;
...
void add_scaler(int M, int N, const double *A, int lda, const double B, double *C, int ldc) {
    int m = 0;
...
void sub_scaler(int M, int N, const double *A, int lda, const double B, double *C, int ldc) {
    int m = 0;
...
void mul_scaler(int M, int N, const double *A, int lda, const double B, double *C, int ldc) {
    if(A == C && lda == ldc && B == 1) return;
...
void div_scaler(int M, int N, const double *A, int lda, const double B, double *C, int ldc) {
    int m = 0;
