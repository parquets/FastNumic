...
inline void dmvma_nr8(int K, const double* A, int lda, const double* B, double* C) {
...
inline void dmvma_nr6(int K, const double* A, int lda, const double* B, double* C) {
    const double* a_ptr0 = A + 0 * lda;
    const double* a_ptr1 = A + 1 * lda;
    const double* a_ptr2 = A + 2 * lda;
    const double* a_ptr3 = A + 3 * lda;
...
inline void dmvma_nr4(int K, const double* A, int lda, const double* B, double* C) {
    const double* a_ptr0 = A + 0 * lda;
    const double* a_ptr1 = A + 1 * lda;
    const double* a_ptr2 = A + 2 * lda;
    const double* a_ptr3 = A + 3 * lda;
...
inline void dmvma_nr1(int K, const double* A, int lda, const double* B, double* C) {
    const double* a_ptr0 = A + 0 * lda;
...
inline void dmvma_tr6(int K, const double* A, int lda, const double* B, double* C) {
    const double* a_ptr0 = A + 0 * lda;
    const double* a_ptr1 = A + 1 * lda;
    const double* a_ptr2 = A + 2 * lda;
    const double* a_ptr3 = A + 3 * lda;
...
inline void dmvma_tr4(int K, const double* A, int lda, const double* B, double* C) {
    const double* a_ptr0 = A + 0 * lda;
    const double* a_ptr1 = A + 1 * lda;
    const double* a_ptr2 = A + 2 * lda;
    const double* a_ptr3 = A + 3 * lda;
...
inline void dmvma_tr1(int K, const double* A, int lda, const double* B, double* C) {
    for (int k = 0; k < K; ++k) {
        C[k] += A[k] * B[0];
    }
}
