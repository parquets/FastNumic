...
inline void smvma_nr8(int K, float alpha, const float* A, int lda, const float* B, float beta, float* C) {
    ...
    for (k = 0; k < K - 7; k += 8) {
        ...
        _v_b0 = _mm256_mul_ps(_v_b0, _v_alpha);
...
inline void smvma_nr6(int K, float alpha, const float* A, int lda, const float* B, float beta, float* C) {
    const float* a_ptr0 = A + 0 * lda;
    const float* a_ptr1 = A + 1 * lda;
    const float* a_ptr2 = A + 2 * lda;
    const float* a_ptr3 = A + 3 * lda;
    ...
    for (k = 0; k < K - 15; k += 16) {
        ...
        _v_b0 = _mm256_mul_ps(_v_b0, _v_alpha);
        _v_b1 = _mm256_mul_ps(_v_b1, _v_alpha);
...
inline void smvma_nr4(int K, float alpha, const float* A, int lda, const float* B, float beta, float* C) {
    const float* a_ptr0 = A + 0 * lda;
    const float* a_ptr1 = A + 1 * lda;
    const float* a_ptr2 = A + 2 * lda;
    const float* a_ptr3 = A + 3 * lda;
...
inline void smvma_nr1(int K, float alpha, const float* A, int lda, const float* B, float beta, float* C) {
    const float* a_ptr0 = A + 0 * lda;
...
inline void smvma_tr6(int K, float alpha, const float* A, int lda, const float* B, float beta, float* C) {
    const float* a_ptr0 = A + 0 * lda;
    const float* a_ptr1 = A + 1 * lda;
    const float* a_ptr2 = A + 2 * lda;
    const float* a_ptr3 = A + 3 * lda;
    ...
    _v_w0 = _mm256_mul_ps(_v_w0, _v_alpha);
    _v_w1 = _mm256_mul_ps(_v_w1, _v_alpha);
    _v_w2 = _mm256_mul_ps(_v_w2, _v_alpha);
    _v_w3 = _mm256_mul_ps(_v_w3, _v_alpha);
    _v_w4 = _mm256_mul_ps(_v_w4, _v_alpha);
    _v_w5 = _mm256_mul_ps(_v_w5, _v_alpha);
...
inline void smvma_tr4(int K, float alpha, const float* A, int lda, const float* B, float beta, float* C) {
    const float* a_ptr0 = A + 0 * lda;
    const float* a_ptr1 = A + 1 * lda;
    const float* a_ptr2 = A + 2 * lda;
    const float* a_ptr3 = A + 3 * lda;
...
inline void smvma_tr1(int K, float alpha, const float* A, int lda, const float* B, float beta, float* C) {
    const float* a_ptr0 = A + 0 * lda;
    __m256 _v_alpha = _mm256_broadcast_ss(&alpha);
    __m256 _v_w0 = _mm256_broadcast_ss(B + 0);
    _v_w0 = _mm256_mul_ps(_v_w0, _v_alpha);
